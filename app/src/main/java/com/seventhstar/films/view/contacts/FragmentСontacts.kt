package com.seventhstar.films.view.contacts
...
import com.seventhstar.films.databinding.FragmentContactsBinding
...
class FragmentContacts : Fragment() {
   ...
   // private val adapter = ContactsFragmentAdapter()//
